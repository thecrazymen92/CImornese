...
<div id="login-form">
    ...
    <fieldset>
        <form action="<?php echo base_url();?>login/loginparams/" method="post">
            <input value="yanpool.valencia@mornese.pe" id="usuario" name="usuario" type="text" required placeholder="">
            <input value="12345678" id="clave" name="clave" type="password" required placeholder="">
